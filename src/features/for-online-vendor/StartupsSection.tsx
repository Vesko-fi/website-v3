  ...
  const benefits = [
    {
      ...
      titleKey: "forOnlineVendor.startups.benefits.startJourney.title",
      descKey: "forOnlineVendor.startups.benefits.startJourney.description",
    },
    {
      icon: RemixIcons.customers,
      color: "from-green-500 to-blue-500",
      titleKey: "forOnlineVendor.startups.benefits.findCustomers.title",
      descKey: "forOnlineVendor.startups.benefits.findCustomers.description",
    },
    {
      icon: RemixIcons.growth,
      color: "from-purple-500 to-pink-500",
      titleKey: "forOnlineVendor.startups.benefits.growTogether.title",
      descKey: "forOnlineVendor.startups.benefits.growTogether.description",
    },
  ];
      ...
      <Container>
        ...
        >
          ...
          <div className='flex flex-col gap-2'>
            ...
            <motion.div variants={textVariants}>
              <Text className='max-w-2xl text-lg text-gray-600 md:text-xl'>
                {t("forOnlineVendor.startups.description")}
              </Text>
            </motion.div>
          </div>
