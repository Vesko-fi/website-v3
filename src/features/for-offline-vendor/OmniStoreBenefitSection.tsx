        ...
        >
          ...
          <motion.div variants={buttonVariants}>
            <NavItem
              ...
              routeKey='register'
              isCTA
              className='from-accent-500 hover:from-accent-600 to-accent-600 hover:to-accent-700 border-0 bg-gradient-to-bl px-8 py-4 text-lg font-semibold !text-white shadow-lg'
            />
          </motion.div>
